          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: done ? AppTheme.black : AppTheme.dimmed,
                ),
                borderRadius: BorderRadius.circular(6),
              ),
              child: done
            ...
            Text(
              ...
              style: TextStyle(
                ...
                fontSize: 10,
                letterSpacing: 0.6,
                color: done ? AppTheme.muted : AppTheme.black,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isFeatured ? AppTheme.black : AppTheme.border,
        ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isDarkIcon ? AppTheme.black : AppTheme.border,
              ),
              borderRadius: BorderRadius.circular(10),
            ),
            child: Icon(
              icon,
              size: 16,
              color: isDarkIcon ? Colors.white : AppTheme.black,
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
