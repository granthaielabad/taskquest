...
class SolveAlgorithmGameplayScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SolveAlgorithmGameplayScreen> createState() =>
      _SolveAlgorithmGameplayScreenState();
}

class _SolveAlgorithmGameplayScreenState
    extends ConsumerState<SolveAlgorithmGameplayScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => GameResultsScreen(
              result: result,
              gameTitle: next.config?.title ?? 'Solve Algorithm',
            ),
          ),
        );
      }
    ...
    final question = gameState.currentQuestion as AlgorithmProblem;
