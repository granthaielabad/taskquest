                        ...
                        children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: const TextStyle(fontFamily: 'DM Mono', fontSize: 10, color: Colors.white24),
                                ),
                              ],
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: Wrap(
                              ...
                              children: _buildCodePuzzles(question, isAnswered),
                            ),
                          ),
                        ],
                      ),
                    ...
                    Wrap(
                      ...
                      children: question.availableBlocks.map((opt) {
                        ...
                        return Draggable<String>(
                          ...
                          child: Opacity(opacity: isUsed ? 0.3 : 1.0, child: _buildBlock(opt)),
                        );
                      }).toList(),
                    ),
                  ],
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(
                          gameState.lastAnswerCorrect == true ? 'Success!' : 'Broken Logic', 
          ...
          Padding(
            ...
            child: DragTarget<String>(
              onAcceptWithDetails: (details) {
                ...
                int slotCount = question.codeSegments.where((s) => s == 'slot').length;
                if (_placedBlocks.length == slotCount) {
                  ref.read(gameEngineProvider.notifier).submitAnswer(_placedBlocks);
                }
              },
              builder: (context, candidate, _) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: value != null ? Colors.white12 : Colors.white.withValues(alpha: 0.05),
  ...
  Widget _buildBlock(String label, {bool isDragging = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isDragging ? [BoxShadow(color: Colors.black26, blurRadius: 10, offset: const Offset(0, 4))] : null,
      ),
      child: Text(
        label, 
        style: const TextStyle(fontFamily: 'DM Mono', fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF111111)),
      ),
    );
  }
}
