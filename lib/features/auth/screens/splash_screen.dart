...
class _SplashScreenState extends ConsumerState<SplashScreen>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      if (mounted) {
        _controller.stop();
        // The routing is handled by authStateProvider in main.dart
        // But if we are still on SplashScreen, it means auth is null or loading
        // We only navigate to onboarding if auth is definitely null
